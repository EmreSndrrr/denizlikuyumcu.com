...
export const searchIndex: SearchEntry[] = [
  ...
  { label: "Gram Altın Bugün Ne Kadar?", href: "/rehber/gram-altin-bugun-ne-kadar", group: "Rehber" },
  { label: "10 Gram Altın Kaç TL Eder?", href: "/rehber/10-gram-altin-kac-tl", group: "Rehber" },
  { label: "Çeyrek Altında Alış ve Satış Farkı", href: "/rehber/ceyrek-altin-alis-satis-farki", group: "Rehber" },
  { label: "22 Ayar Bilezik Hesaplama", href: "/rehber/22-ayar-bilezik-hesaplama", group: "Rehber" },
  { label: "14 Ayar Altın Bozdurma Hesabı", href: "/rehber/14-ayar-altin-bozdurma-hesabi", group: "Rehber" },
  { label: "Bilezikte İşçilik Nasıl Hesaplanır?", href: "/rehber/bilezikte-iscilik-hesaplama", group: "Rehber" },
  { label: "Düğünde Hangi Altınlar Takılır?", href: "/rehber/dugunde-hangi-altinlar-takilir", group: "Rehber" },
  { label: "Altın Alırken Fatura Alınmalı mı?", href: "/rehber/altin-alirken-fatura", group: "Rehber" },
  { label: "Sahte Altın Nasıl Anlaşılır?", href: "/rehber/sahte-altin-nasil-anlasilir", group: "Rehber" },
  { label: "Eski ve Yeni Tarihli Çeyrek Altın Farkı", href: "/rehber/eski-yeni-tarihli-ceyrek-altin-farki", group: "Rehber" },
  { label: "Altın Bozdururken Nelere Dikkat Edilmeli?", href: "/rehber/kuyumcuda-altin-bozdururken-dikkat", group: "Rehber" },
  { label: "Alyans Ölçüsü Nasıl Belirlenir?", href: "/rehber/alyans-olcusu-nasil-belirlenir", group: "Rehber" },
  ...priceEntries,
];
